...
extern char  hwid[10];
#define ABC_HARDWARE_ID_HVT "1110"
#define ABC_HARDWARE_ID_DVT "0111"
#define ABCC_HARDWARE_ID_HVT "1001"
...
static void lcd_tcon_vac_set_tl1(unsigned int demura_valid)
{
	...
	if(strcmp(ABC_HARDWARE_ID_HVT, hwid) == 0 ||
       strcmp(ABC_HARDWARE_ID_DVT, hwid) == 0 ||
       strcmp(ABCC_HARDWARE_ID_HVT, hwid) == 0) {
