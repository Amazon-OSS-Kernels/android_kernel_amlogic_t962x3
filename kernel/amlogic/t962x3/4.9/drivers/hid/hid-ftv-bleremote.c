 ...
 *
 * Copyright (C) 2023 Amazon Lab126.
 *
 * Author:
...
static int bleremote_audio_dev_close(struct inode *inode, struct file *file)
{
...
#if defined(CONFIG_AMAZON_METRICS_LOG) || defined(CONFIG_AMAZON_MINERVA_METRICS_LOG)
	{
		...
		log_counter_to_vitals_v2(ANDROID_LOG_INFO,
				KERNEL_BT_HID_GROUP_ID, BT_DEVICE_HID_SCHEMA_ID, "Kernel",
		...
		log_counter_to_vitals(ANDROID_LOG_INFO,
				"Kernel","remote-wireless", "bt-ble-voicesearch",
				"voice-started", 1, "count",metadata, VITALS_NORMAL);
...
#ifdef CONFIG_AMAZON_MINERVA_METRICS_LOG
					log_counter_to_vitals_v2(ANDROID_LOG_INFO,
						KERNEL_BT_HID_GROUP_ID, BT_DEVICE_HID_SHEMA_ID,  "Kernel",
						"remote-wireless", "bt-ble-voicesearch",
...
static const struct hid_device_id ftv_remote_devices[] = {
	{HID_BLUETOOTH_DEVICE(BT_VENDOR_ID_LAB126, USB_DEVICE_ID_LAB126_CAYENNE)},
	{HID_USB_DEVICE(BT_VENDOR_ID_LAB126, USB_DEVICE_ID_LAB126_CAYENNE)},
	...
	{HID_BLUETOOTH_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_LINDBERGH)},
	{HID_USB_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_LINDBERGH)},
	...
	{HID_BLUETOOTH_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_ALDRIN)},
	{HID_USB_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_ALDRIN)},
	{HID_BLUETOOTH_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_ALDRIN2)},
	{HID_USB_DEVICE(BT_VENDOR_ID_LAB126, BT_DEVICE_ID_LAB126_ALDRIN2)},
