 ...
 *
 * Copyright 2016-2023 Amazon Technologies, Inc. All Rights Reserved.
 *
...
static int vital_test(void)
{
...
#ifdef CONFIG_AMAZON_MINERVA_METRICS_LOG
		/* key=NULL case */
		ret = log_timer_to_vitals_v2(ANDROID_LOG_INFO, KERNEL_METRIC_TEST_GROUP_ID, KERNEL_METRICS_VITALS_TIMER_TEST_SCHEMA_ID, "Kernel timer", "TEST",
	...
	for (i = 0; i < loop; i++) {
#ifdef CONFIG_AMAZON_MINERVA_METRICS_LOG
		/* nomral case */
		ret = log_counter_to_vitals_v2(ANDROID_LOG_INFO, KERNEL_METRIC_TEST_GROUP_ID, KERNEL_METRICS_VITALS_COUNTER_TEST_SCHEMA_ID, "Kernel vitals", "TEST",
		...
		/* key=NULL case */
		ret = log_counter_to_vitals_v2(ANDROID_LOG_INFO, KERNEL_METRIC_TEST_GROUP_ID, KERNEL_METRICS_VITALS_COUNTER_TEST_SCHEMA_ID, "Kernel vitals", "TEST", "VITALS",
